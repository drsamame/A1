...
$comments_args = array(
	...
	'title_reply' => 'Comentarios',
	'fields' => apply_filters('comment_form_default_fields', $fields),
	'comment_field' => '<p class="comment-form-comment"><div class="form-group"><label for="comment">' . _x('Comment', 'noun') .
	'</label><textarea id="comment" name="comment" class="form-control"  rows="4" aria-required="true">' .
	'</textarea></div></p>',
	'comment_notes_after' => ' ');
?>
<a id='view-comment' class="" href="#"><span class="glyphicon glyphicon-comment"></span> Dejanos un comentario</a>
<div class="form-comment"><?php comment_form($comments_args); ?></div></div>
